...
const OnboardCard = ({
  ...
  return (
    ...
    >
      <div className="flex min-w-[250px] scale-[0.9] flex-col justify-center gap-2 rounded-md border border-[#342F29]/12 bg-gradient-to-br from-[#ECE1CB] to-[#FAFAFA] py-2 pl-3 pr-16 opacity-80 dark:from-[#1A1714] dark:to-[#0B0A08] dark:border-[#342F29]/40">
        ...
        <div
          className={`ml-5 h-1.5 w-[100%] overflow-hidden rounded-full bg-[#342F29]/12 dark:bg-[#342F29]/40`}
        ></div>
      </div>
      <div className="flex min-w-[250px] flex-col justify-center gap-2 rounded-md border border-[#342F29]/12 bg-gradient-to-br from-[#ECE1CB] to-[#FAFAFA] py-2 pl-3 pr-16 dark:from-[#1A1714] dark:to-[#0B0A08] dark:border-[#342F29]/40">
      ...
      <div className="flex min-w-[250px] scale-[0.9] flex-col justify-center gap-2 rounded-md border border-[#342F29]/12 bg-gradient-to-br from-[#ECE1CB] to-[#FAFAFA] py-2 pl-3 pr-16 opacity-80 dark:from-[#1A1714] dark:to-[#0B0A08] dark:border-[#342F29]/40">
        <div className="flex items-center justify-start text-xs text-primary">
          <div className="relative">
            <svg width="20" height="20">
              <circle cx="10" cy="10" r="5" fill="#48684C" />
            </svg>
        ...
        <div
          className={`ml-5 h-1.5 w-[100%] overflow-hidden rounded-full bg-[#48684C]`}
        ></div>
      </div>
