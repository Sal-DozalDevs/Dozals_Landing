...
description: Use when creating, editing, or rendering Remotion video compositions in React. Covers animation, sequencing, captions, audio, 3D, transitions, and all Remotion APIs.
metadata:
